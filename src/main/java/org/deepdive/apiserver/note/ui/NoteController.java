...
public class NoteController {
    ...
    @GetMapping("/{note_id}")
    public ResponseDto<GetNoteResponseDto> getNote(@Login Long memberId,
        @PathVariable("note_id") Long noteId) {
        return ResponseDto.ok(noteService.getNote(memberId, noteId));
    }

    @PostMapping("")
    public CommonSuccessDto createNote(@Login Long memberId,
    ...
    public CommonSuccessDto updateNote(@Login Long memberId, @RequestBody UpdateNoteRequestDto dto,
        @PathVariable("note_id") Long noteId) {
